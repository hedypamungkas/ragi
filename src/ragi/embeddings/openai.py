"""ragi/embeddings/openai -- OpenAI-compatible embedding adapter.

Uses :class:`ragi._internal.http.HttpTransport` (POST-with-retry + Bearer
auth) so an embedding backend can be configured without pulling in the OpenAI SDK.
Satisfies :class:`ragi.protocols.EmbeddingClient`.
...
from ragi.errors import LLMError
