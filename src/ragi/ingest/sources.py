"""ragi/ingest/sources -- remote document fetching (HTTP / S3 / Firecrawl) + cache.
...
def fetch_s3_entry(
    ...
    *,
    ...
    try:
        ...
        raise LLMInvalidRequestError("(rag-cloud) boto3 required: pip install 'ragi[rag-cloud]'") from exc
    if max_bytes is None:
        max_bytes = _DEFAULT_MAX_DOC_BYTES
