"""ragi/vectorstore/faiss -- FAISS-backed VectorStore (cosine via IndexFlatIP).
...
:func:`ragi.ingest.filters.matches_filter` (same predicate the memory backend uses).
...
_INSTALL_HINT = "pip install 'ragi[vector-faiss]'"
