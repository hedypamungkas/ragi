"""ragi/eval/runner -- StandaloneEvalRunner (Mode A, retrieval-only).
...
from ragi.eval.rubric import evaluate_rubric, format_rubric
...
if TYPE_CHECKING:
    from ragi.protocols import ChatClient, Retriever
