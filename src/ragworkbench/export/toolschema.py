"""ragworkbench/export/toolschema -- static tool-schema generator for the search tool.
...
WITHOUT importing ragworkbench (or any heavy dep) at the agent layer. The schema is
