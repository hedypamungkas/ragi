"""ragworkbench/retrieval/rerank -- pluggable cross-encoder rerank stage.
...
:class:`LLMError` hierarchy that already live in ragworkbench, and co-locates
    ...
    def __init__(self, model: str = "BAAI/bge-reranker-v2-m3"):
        try:
            ...
            raise LLMInvalidRequestError(
                "(rerank-local) sentence-transformers required: pip install 'ragworkbench[rerank-local]'"
            ) from e
