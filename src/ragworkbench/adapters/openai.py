"""ragworkbench/adapters/openai -- OpenAI function-calling tool-call dispatch.
...
from ragworkbench.adapters._dispatch import dispatch_search, dispatch_search_async
from ragworkbench.export.toolschema import to_openai
